...
<div data-aos="fade-right" data-aos-delay="100" data-aos-duration="4000">
    <main>
        ...
        <Link className="btn btn-danger fw-bold text-uppercase border border-warning py-2 my-4 link-to-alllearners" to="/apprenants"><span className="h4">Espace de gestion</span></Link>
